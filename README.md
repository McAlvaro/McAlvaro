...
class McAlvaro extends Profile {

    protected $name = 'Remberto Alvaro Molina Colodro';
    protected $area = 'Backend';
    protected $job = 'Emizor';
    protected $country = 'Bolivia';
...
<details>
  <summary> ⌨️ Lenguajes & DBs</summary>
...
![Livewire](https://img.shields.io/static/v1?style=for-the-badge&message=Livewire&color=4e57a6&logo=Livewire&logoColor=fb70a9&label=)
...
<img align="left" height="50px" width="50px" alt="Estacio" src="https://github.com/McAlvaro/McAlvaro/blob/main/Platzi.png"/>
...
[<img align="left" alt="Beacons" width="80px" src="https://github.com/AnaProgramando/AnaProgramando/blob/31ac40741768033915a37ec0f949984bf6aad2d1/beacons_logo.png"/>](https://beacons.ai/mcalvaro)
